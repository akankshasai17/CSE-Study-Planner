...
def evaluate_code(question_title, user_code):
...
"""
    ...
    try:
        ...
        # Execute the python script in a subprocess with a timeout
        res = subprocess.run(
        ...
        if res.returncode == 0:
            ...
            # Truncate internal temp file path details for cleanliness
            clean_error = error_msg.replace(temp_path, "solution.py")
            return {
                "success": False,
                "error": clean_error
            }
